	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 appendResult17 = (float4((( clampResult60 + tex2D( _t_ui_fond, uv047 ) )).rgb , smoothstepResult10));
...
/*ASEBEGIN
Version=17700
-1827;42;1691;859;2091.334;171.568;1;True;True
...
ASEEND*/
//CHKSM=369B8F02621A6BD1573EED7D7CFEEDB5D51BB64F