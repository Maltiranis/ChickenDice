...
public class sc_UIInterPhase : MonoBehaviour
{
    ...
    private IEnumerator PlayMusicFond()
    {

        yield return new WaitForSeconds(2f);
        Debug.Log("On passe sur la 0");
        GameObject _MusicManager = GameObject.Find("MusicManager");
        if (_MusicManager != null)
        {
            _MusicManager.GetComponent<sc_MusicManager>()._musicSelected = 0;
        }
    }
}
